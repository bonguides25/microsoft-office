# You need to have Administrator rights to run this script!
    if (-not([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")) {
        ...
        Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "irm office.bonguides.com"
        break
    }
...
<Window x:Class="install.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Office Installation Tool - https://bonguides.com" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" Icon="https://raw.githubusercontent.com/installoffice/setup/refs/heads/main/files/images.png" Width="1140" Height="522">
    <Grid Margin="0,0,0,-6">
        <GroupBox x:Name="groupBoxMicrosoftOffice" Header="Select a product to install:" BorderBrush="#FF164A69" Margin="125,10,0,0" Height="448" Width="986" FontFamily="Consolas" FontSize="11" HorizontalAlignment="Left" VerticalAlignment="Top">
            <Canvas HorizontalAlignment="Left" VerticalAlignment="Top">
                <Rectangle Height="81" Stroke="#FFDA2323" Width="135" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Left="11" Canvas.Top="20" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                ...
                <Rectangle Height="306" Stroke="#FF3C10DE" Width="150" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Left="159" Canvas.Top="20" HorizontalAlignment="Center" VerticalAlignment="Top" Margin="160,0,0,0"/>
                ...
                <Rectangle Height="306" Stroke="#FF0F8E40" Width="150" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Left="325" Canvas.Top="20" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="160,0,0,0"/>
                ...
                <Rectangle Height="306" Stroke="#FFA28210" Width="150" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Left="490" Canvas.Top="20" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="160,0,0,0"/>
                ...
                <Rectangle Height="306" Stroke="#FF1B0F0F" Width="150" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Left="656" Canvas.Top="20" VerticalAlignment="Center" Margin="160,0,50,0"/>
                ...
                <RadioButton x:Name="radioButton2013Access" Content="Access" VerticalContentAlignment="Center" IsChecked="False" Padding="5,5,5,5" Canvas.Top="230" Canvas.Left="670" VerticalAlignment="Center" Margin="160,5,50,0"/>
                ...
                <Rectangle x:Name="RemoveAll" Stroke="#FFDC281F" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Height="50" Width="316" Canvas.Top="347" Canvas.Left="600" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                <RadioButton x:Name="radioButtonRemoveAllApp" Content="I Agree (Caution!)" FontFamily="Consolas" FontSize="11" VerticalContentAlignment="Center" IsChecked="False" Canvas.Left="613" Canvas.Top="366" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                <TextBlock x:Name="textBoxRemoveAll" TextWrapping="Wrap" Text="(*) This option removes all installed Office apps." FontSize="10.5" Canvas.Left="598" Canvas.Top="405" Foreground="#FFED551B" HorizontalAlignment="Center" VerticalAlignment="Top" FontWeight="Bold"/>
                <TextBox x:Name="textBox1" TextWrapping="Wrap" Text="(*) By default, this script installs the 64-bit version in English." Canvas.Top="351" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2"/>
                <TextBox x:Name="textBox2" TextWrapping="Wrap" Text="(*) Default mode is Install. If you want to download only, select Download mode." Canvas.Top="374" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2"/>
                <TextBox x:Name="textBox3" TextWrapping="Wrap" Text="(*) The downloaded files would be saved on the current user's desktop." Canvas.Top="396" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2"/>
                <Label x:Name="LabelRemoveAll" Content="Remove All Apps:" FontWeight="Bold" Canvas.Left="612" Canvas.Top="334" HorizontalAlignment="Center" VerticalAlignment="Top" Background="White"/>
                <Button x:Name="buttonRemoveAll" Content="Remove All" Background="#FFE23B15" FontFamily="Consolas" FontSize="10" Foreground="White" Height="27" Width="73" UseLayoutRounding="True" BorderBrush="{x:Null}" HorizontalAlignment="Center" Canvas.Left="780" Canvas.Top="358" VerticalAlignment="Top"/>
                <Rectangle Height="306" Stroke="#FFE2820E" Width="150" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Canvas.Top="20" HorizontalAlignment="Left" Canvas.Left="156" VerticalAlignment="Top"/>
        ...
        <GroupBox x:Name="groupBoxMode" Header="Mode:" Margin="10,161,0,0" BorderBrush="#FF0D4261" HorizontalAlignment="Left" VerticalAlignment="Top" FontFamily="Consolas" FontSize="11" Width="104" Height="70" ToolTip="When selecting the Activate mode...">
            <StackPanel HorizontalAlignment="Left" VerticalAlignment="Top">
        ...
        <GroupBox x:Name="groupBoxLanguage" Header="Language:" Margin="10,241,0,0" BorderBrush="#FF0D4261" HorizontalAlignment="Left" VerticalAlignment="Top" FontFamily="Consolas" FontSize="11" Width="104" Height="217">
            <StackPanel HorizontalAlignment="Left" VerticalAlignment="Top" Height="186">
                <RadioButton x:Name="radioButtonEnglish" Content="English" VerticalContentAlignment="Center" IsChecked="True" HorizontalAlignment="Left" Margin="5,8,0,0"/>
                <RadioButton x:Name="radioButtonJapanese" Content="Japanese" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonKorean" Content="Korean" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonChinese" Content="Chinese" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonFrench" Content="French" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonSpanish" Content="Spanish" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonHindi" Content="Hindi" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonGerman" Content="German" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
                <RadioButton x:Name="radioButtonVietnamese" Content="Vietnamese" VerticalContentAlignment="Center" HorizontalAlignment="Left" Margin="5,6,0,0"/>
            </StackPanel>
        </GroupBox>
...
# Download links
    $uri            = "https://github.com/bonguides25/microsoft-office/raw/refs/heads/main/files/setup.exe"
    $uri2013        = "https://github.com/bonguides25/microsoft-office/raw/refs/heads/main/files/bin2013.exe"
    $uri2016        = "https://github.com/bonguides25/microsoft-office/raw/refs/heads/main/files/setup.exe"
    $uninstall      = "https://github.com/bonguides25/microsoft-office/raw/refs/heads/main/files/setup.exe"
    $removeAllXML   = "ttps://raw.githubusercontent.com/bonguides25/microsoft-office/refs/heads/main/files/configuration.xml"

# Prepiaration for download and install
    function PreparingOffice {
        if ($radioButtonDownload.IsChecked) {
            $workingDir = New-Item -Path $env:userprofile\Desktop\$productName Directory -Force
